...
//                    if (connection.name == null) return;
                    ...
                    if (message.equals("pressF5")){
                        new RobotCommand().pressF5();
                    }

                    if (message.equals("leftArrow")){
                        new RobotCommand().pressLeftArrow();
                    }
                    if (message.equals("rightArrow")){
                        new RobotCommand().pressRightArrow();
                    }

                    if (message.equals("ESC")){
                        new RobotCommand().pressESC();
                    }
        ...
        JFrame frame = new JFrame("Remote Server");
        ...
        frame.getContentPane().add(new JLabel("Close to stop the Remote server."));
